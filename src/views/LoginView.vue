      ...
      <div class="glass-card-solid p-8 lg:p-10 animate-slide-up order-2 lg:order-1">
        ...
        <div v-else class="space-y-6">
          <div class="text-center">
            <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-blue-50 to-green-50 mb-4">
          ...
          >
            <div class="google-btn-inner">
              <div class="google-icon-wrapper">
                ...
                <svg v-else class="w-5 h-5 animate-spin text-gray-600" fill="none" viewBox="0 0 24 24">
                  <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"/>
                  <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"/>
                </svg>
              </div>
              <span class="google-btn-text">{{ loading ? 'Memproses...' : 'Masuk dengan Google' }}</span>

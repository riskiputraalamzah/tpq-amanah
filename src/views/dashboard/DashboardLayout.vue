    ...
    <aside class="sidebar" :class="{ 'sidebar-open': isSidebarOpen }">
      ...
      <nav class="sidebar-nav">
        ...
        <template v-if="isAdmin">
          ...
          <router-link to="/dashboard/admin-ljp" class="sidebar-link" :class="{ active: isActive('/dashboard/admin-ljp') }">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <template v-if="isAdmin">
          ...
          <router-link to="/dashboard/broadcasts" class="sidebar-link" :class="{ active: isActive('/dashboard/broadcasts') }">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <template v-if="isGuru">
          ...
          <router-link to="/dashboard/ljp" class="sidebar-link" :class="{ active: isActive('/dashboard/ljp') }">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
              <polyline points="14 2 14 8 20 8"/>
              <line x1="16" y1="13" x2="8" y2="13"/>
